...
/** @type {string} */
const CACHE_VERSION = '1739829218|215570348';
/** @type {string} */
const CACHE_PREFIX = 'Third Person Sho-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Third Person Shooter (TPS) Demo.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Third Person Shooter (TPS) Demo.html","Third Person Shooter (TPS) Demo.js","Third Person Shooter (TPS) Demo.offline.html","Third Person Shooter (TPS) Demo.icon.png","Third Person Shooter (TPS) Demo.apple-touch-icon.png","Third Person Shooter (TPS) Demo.worker.js","Third Person Shooter (TPS) Demo.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["Third Person Shooter (TPS) Demo.wasm","Third Person Shooter (TPS) Demo.pck","Third Person Shooter (TPS) Demo.side.wasm"];
